...
In the same way, we can also map the organoid data. Here we found that we need some more genes to properly map the data, so 
...
kanton_voxmap <- voxel_map(kanton_ge_srt, group_name='ge_substruct', genes_use=mayer_markers)
